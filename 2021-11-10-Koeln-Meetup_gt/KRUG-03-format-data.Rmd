...
With `exibble` make a simple **gt** table. Format the `num` column as numeric with three decimal places and do this formatting according to the `"de"` locale.
...
exibble %>%
  ...
  fmt_number(
    columns = num,
    locale = "de" # <- try: "fr", "fr_CA", "de_AT" (i.e., <lang>_<region>)
  )
```
