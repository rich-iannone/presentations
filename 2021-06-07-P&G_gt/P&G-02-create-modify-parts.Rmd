...
Modify the header background color (with `heading.background.color`) to be `"lightcyan"`.
...
Speaking of footnotes, we can change the background color of the footnotes area (with `footnotes.background.color`) to be `"gray"`.

```{r}
tab_1 %>%
  tab_options(
    footnotes.background.color = "gray"
  )
```
